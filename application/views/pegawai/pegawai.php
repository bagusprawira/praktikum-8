              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php 
                  foreach($pegawai as $data){
                      ...
                      <td><a href='".base_url("Peminjaman_controller/editPegawai/").$data->KdPetugas."'><button class='btn btn-primary'>Ubah</button></a></td>
                      <td><button onclick='del(".$data->KdPetugas.")' class='btn btn-danger'>Delete</button></td>
                      </tr>";
                    }
                 ?>
                </tbody>
